	...
	a.fn.upload = function(D) {
		var r = a(this),
			...
			j, u, t, o, n, m, y, B = {
				...
				width: r.attr("data-width") ? r.attr("data-width") : 800,
				type: r.attr("data-type") ? r.attr("data-type") : "png,jpg,jpeg,gif",
				upname: r.attr("data-file") ? r.attr("data-file") : "file",
				save: r.attr("data-save") ? r.attr("data-save") : "upload/tmp/{Rnd}.{Ext}",
				inputname: r.attr("data-name") ? r.attr("data-name") : "upload",
				num: r.attr("data-num") ? r.attr("data-num") : 10,
				action: r.attr("action") ? r.attr("action") : "upload.php",
				size: r.attr("data-size") ? r.attr("data-size") : 1048576,
		...
		a(this).on("mousemove", function(G) {
			if (j) {
				var F = G.pageX - u;
				var J = G.pageY - t;
				var I = j.index();
